  ...
  return (
    <div className={styles.sheet}>
      ...
      <div className={styles.Box}>
        ...
        <input className={styles.customInput} placeholder="Да вы известный человек:)" type="text" />
      </div>
      <div className={styles.Box} style={{ marginBottom: '80px' }}>
        <div className={styles.information}>Username</div>
        <input className={styles.customInput} placeholder="Введите никнейм" type="text" />
        <div className={styles.attachment}>Минимально допустимая длина - 5 символов</div>
      </div>
      <div className={styles.Box} style={{ height: '120px' }}>
        <div className={styles.information}>О себе</div>
        <input className={styles.customInput} placeholder="Порадуйте нас!" type="text" />
